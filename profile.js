...
document.querySelector("#changeProfile").addEventListener("click", () => { setAuthMode("login"); profileForm.hidden = false; profileEmail.focus(); });
...
document.querySelector("#deleteProfileData").addEventListener("click", () => toast("Solicita al administrador eliminar tu cuenta y cotizaciones"));
